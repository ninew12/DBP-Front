<template>
  <div>
    <sdPageHeader title="ประวัติการทำงาน">
    ...
    <Main>
      <div style="display: flex; justify-content: flex-end; margin-bottom: 20px">
        <SelectWrapperStyle>
          <a-select v-model:value="value1" @focus="focus" ref="select" @change="handleChange">
            <a-select-option value="โรงงาน">สายการผลิต</a-select-option>
            <a-select-option value="Yiminghe">yiminghe</a-select-option>
          </a-select>
        </SelectWrapperStyle>
        <SelectWrapperStyle>
          <a-select v-model:value="value1" @focus="focus" ref="select" @change="handleChange">
            <a-select-option value="โรงงาน">แผนก</a-select-option>
            <a-select-option value="Yiminghe">yiminghe</a-select-option>
          </a-select>
        </SelectWrapperStyle>
        <SelectWrapperStyle>
          <a-select v-model:value="value1" @focus="focus" ref="select" @change="handleChange">
            <a-select-option value="โรงงาน">ผู้รักผิดชอบ</a-select-option>
            <a-select-option value="Yiminghe">yiminghe</a-select-option>
          </a-select>
        </SelectWrapperStyle>
        <SelectWrapperStyle>
          <a-select v-model:value="value1" @focus="focus" ref="select" @change="handleChange">
            <a-select-option value="โรงงาน">ประเภท</a-select-option>
            <a-select-option value="Yiminghe">yiminghe</a-select-option>
          </a-select>
        </SelectWrapperStyle>
        <SelectWrapperStyle>
          <a-select v-model:value="value1" @focus="focus" ref="select" @change="handleChange">
            <a-select-option value="โรงงาน">ทั้งหมด</a-select-option>
            <a-select-option value="Yiminghe">yiminghe</a-select-option>
          </a-select>
        </SelectWrapperStyle>
        <DatePickerWrapper>
        ...
        <!-- <a-form name="sDash_grid-form" layout="horizontal">
          <a-form-item>
            <a-input name="grid-2-1" placeholder="search" />
          </a-form-item>
        </a-form> -->
      </div>
      <div>
        ...
        ? [
            {
              key: '1',
              pages: (
                <router-link to="/work/detail" class="page-title">
                  Homepage
                </router-link>
              ),
